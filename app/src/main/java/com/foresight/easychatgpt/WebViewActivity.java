...
import com.foresight.utility.Constants;
import com.foresight.utility.LoadingDialog;
import com.foresight.utility.RSAUtility;
...
public class WebViewActivity extends AppCompatActivity {
       ...
       // mWebview = (WebView) findViewById(R.id.webViewOn);
        ...
        mWebview.setWebViewClient(new WebViewClient() {
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                if (url.equalsIgnoreCase("https://www.eagetutor.com/offerVcPaySuccess.do")) {
                       new PaymentUser().execute(sharedMobile);
        ...
        String payment_eage_url=AvenuesParams.URL_Eagetutor+"?amount="+AvenuesParams.Amount_Chat+"&tid="+newRandomId+"&order_id="+newRandomId;

        mWebview.loadUrl(payment_eage_url);
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            final WebView webview = (WebView) findViewById(R.id.webViewOn);
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public void onPageStarted(WebView view, String url, Bitmap favicon) {
                    super.onPageStarted(view, url, favicon);
                    LoadingDialog.showLoadingDialog(WebViewActivity.this, "Loading...");
                    if (url.startsWith("https://secure.ccavenue.com/transaction")) {
                        SharedPreferences myPrefs = getApplicationContext().getSharedPreferences("MyPref", 0);
                        String sharedEmail = myPrefs.getString("Unique_Email", null);
                        new PaymentUser().execute(sharedEmail);
                    }
                }
            });
